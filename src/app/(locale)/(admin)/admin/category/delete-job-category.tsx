...
import { useDeleteCategory } from "@/queries/categories.query";
...
const DeleteComicCategory = ({ item, setItem }: IProps) => {
  const { mutateAsync, isPending } = useDeleteCategory(getAccessToken() ?? "");
...
export default memo(DeleteComicCategory);
