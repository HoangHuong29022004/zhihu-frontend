...
import { useDeleteChapter } from "@/queries/chapter.query";
...
const DeleteChapter = ({ item, setItem, comicSlug }: IProps) => {
  const { mutateAsync, isPending } = useDeleteChapter(getAccessToken() ?? "");
