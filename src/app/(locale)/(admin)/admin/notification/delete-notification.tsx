...
import { useDeleteNotification } from "@/queries/notification.query";
...
const DeleteNotification = ({ item, setItem }: IProps) => {
  const { mutateAsync, isPending } = useDeleteNotification(
    getAccessToken() ?? ""
  );
