...
const AdminNotificationClient: React.FC = () => {
  ...
  const { isLoading, data, refetch, isRefetching } = useGetNotifications({
    pageNumber,
    pageSize,
    search: txtSearch,
  });
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex justify-between flex-wrap gap-4 bg-white px-4 py-6 rounded-xl">
        ...
        <div className="flex gap-3 flex-wrap">
          ...
          <UpdateNotification item={updatedItem} setItem={setUpdatedItem} />
          <DeleteNotification item={deletedItem} setItem={setDeletedItem} />
        </div>
      </div>

      {/* Data table */}
      <DataTableComponent
        headers={["Tên thông báo", "Ảnh bìa", "Tác giả", "Ngày tạo"]}
        data={data && data?.data}
        ...
        renderCells={(row: INotification) => (
          <>
            ...
            <TableCell>{row.accountName || "_"}</TableCell>
